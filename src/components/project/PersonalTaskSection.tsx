...
export function PersonalTaskSection(): JSX.Element {
  ...
  return (
    <section className="lg:h-full bg-gradient-to-b from-bluegray-50 via-bluegray-50 to-bluegray-100 rounded-[60px] overflow-auto px-4 sm:px-6 py-10 transition shadow hover:shadow-2xl">
